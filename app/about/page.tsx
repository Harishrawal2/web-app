                    ...
                    <div className=" mx-auto">
                        <div className="flex flex-col sm:flex-row mt-10">
                            <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                                ...
                                border-4 border-gray-900 inline-flex items-center justify-center text-gray-900">
                                    <Image src='/picofme.png' alt='harishrawal' className='rounded-full' width={500} height={500} />
                                </div>
                            ...
                            <div className="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left mx-10">
                                <h1 className='text-gray-900 font-bold text-4xl mb-4'>About Us</h1>

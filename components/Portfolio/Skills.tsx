                            ...
                            skill.map((items) => (
                                <>
                                    <div className="lg:w-2/6 md:w-1/2 w-1/2 xl:p-5 lg:p-5 md:p-4 p-2" key={items.id}>
                                        <div className="border border-gray-200 bg-white skillsPoint hover:transform hover:scale-105 transition-transform duration-300 ease-in-out p-6 rounded-lg cursor-pointer">
